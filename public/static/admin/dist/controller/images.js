...
layui.define(["table", "form"],
    function (obj) {
        ...
        $('#forceImagesDelete').click(function (data) {
            layer.confirm('确定删除吗？强制删除会屏蔽错误信息以实现删除', {icon: 3, title: '提示'}, function (index) {
                var checkStatus = table.checkStatus('table');
                var data = checkStatus.data;
                var images = [];
                data.forEach(function (value, index) {
